...
#7
/*
Það er engin tala í þessum töflum sem segir til um það hversu marga bíla hver sölumaður hefur selt,
mér datt í hug að það gæti verið numer í sölu töflunni en það er AUTO_INCREMENT.
*/

#8
SELECT nafn_eig AS "Nafn",
	solumadur_kt AS "Kennitala",
	bill.fastanumer AS "Bílnúmer",
	tegund AS "Tegund"
